...
class Pool:
    ...
    def addM(stock, attack, health, type, minion_tier, taunt=False, divine_shield=False, poisonous=False, windfury=False, magnetic=False):
        minion_dict = {"stock": stock, "attack": attack, "type": minion_type}
        if(taunt):
